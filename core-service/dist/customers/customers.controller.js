...
const sync_customers_dto_1 = require("./dto/sync-customers.dto");
let CustomersController = class CustomersController {
    constructor(customersService) {
        this.customersService = customersService;
    }
    sync(syncCustomersDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Sync dummy customers' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [sync_customers_dto_1.SyncCustomersDto]),
