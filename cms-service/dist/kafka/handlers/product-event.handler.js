...
exports.ProductEventHandler = void 0;
...
let ProductEventHandler = class ProductEventHandler extends base_event_handler_1.BaseEventHandler {
    constructor(cdcTransformer, syncService, dlqService) {
        super(cdcTransformer, syncService, dlqService);
    }
    async handleProductChanged(message) {
        await this.processEvent(message, enums_1.CDC_TABLE_NAMES.PRODUCTS, (event) => this.syncService.syncProductEvent(event));
    }
};
exports.ProductEventHandler = ProductEventHandler;
__decorate([
    (0, microservices_1.EventPattern)(enums_1.KAFKA_TOPICS.PRODUCTS),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ProductEventHandler.prototype, "handleProductChanged", null);
exports.ProductEventHandler = ProductEventHandler = __decorate([
...
//# sourceMappingURL=product-event.handler.js.map